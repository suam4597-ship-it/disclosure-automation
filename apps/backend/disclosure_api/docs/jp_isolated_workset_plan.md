# JP isolated workset plan

This document describes the later isolated runtime implementation PR that may follow after JP contract-freeze.

This discovery-only PR must not create the runtime workset files listed here.

## Prerequisite

Do not start the implementation workset until the JP contract-freeze package has chosen:
...
The later JP runtime PR should be narrow:
...
- one detail fixture
- one attachment/PDF fixture only if required
- one runtime adapter
...
Use exact paths only after contract freeze. Replace `jp_<chosen_source>` with the frozen source key.

```text
apps/backend/disclosure_api/lib/disclosure_automation/runtime/jp_<chosen_source>_adapter.ex
apps/backend/disclosure_api/lib/disclosure_automation/ops/jp_<chosen_source>_source.ex
apps/backend/disclosure_api/priv/config_samples/source_registry.jp_<chosen_source>.sample.yaml
...
apps/backend/disclosure_api/priv/ops/run_jp_<chosen_source>_server.exs
apps/backend/disclosure_api/priv/ops/jp_<chosen_source>_dedupe_checks.sql
apps/backend/disclosure_api/test/jp_<chosen_source>_runtime_idempotency_test.exs
apps/backend/disclosure_api/test/jp_<chosen_source>_http_smoke_test.exs
apps/backend/disclosure_api/docs/jp_<chosen_source>_manual_smoke.md
apps/backend/disclosure_api/docs/jp_<chosen_source>_minimal_verification.md
```
...
```text
apps/backend/disclosure_api/lib/disclosure_automation/runtime/jp_*.ex
apps/backend/disclosure_api/lib/disclosure_automation/ops/jp_*_source.ex
apps/backend/disclosure_api/priv/config_samples/source_registry.jp_*.sample.yaml
apps/backend/disclosure_api/priv/fixtures/source_payloads/jp_*
apps/backend/disclosure_api/test/jp_*
apps/backend/disclosure_api/priv/ops/jp_*
```
...
- multiple JP source families
- multiple JP official surfaces in one adapter
- broad CN expansion
- news overlay
- cross-source merge
