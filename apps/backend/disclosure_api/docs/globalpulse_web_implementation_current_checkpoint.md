...
2. Continue scheduled observation summaries for EU canary, Denmark DFSA OAM, and India NSE as runs accumulate.
3. Keep checking public web smoke and source-health drift.
