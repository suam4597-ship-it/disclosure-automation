...
25. Keep Bulgaria X3News Issuer Disclosures as a new manual_staging_only Bulgarian Stock Exchange group issuer-disclosure candidate with local and staging smoke pending.
