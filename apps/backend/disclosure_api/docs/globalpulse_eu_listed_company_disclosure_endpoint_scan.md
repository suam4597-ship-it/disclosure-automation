...
Public browser visual smoke remains pending.
Scheduled polling remains disabled until the broader Europe source batch is intentionally promoted.
```
...
26. Keep Turkey KAP Company Notifications as a proven manual_staging_only official public-disclosure-platform candidate with local fixture/live parser smoke passing, Fly staging live poll passing, latest backend digest visibility passing, and public browser visual smoke pending.
...
TURKEY_KAP_COMPANY_NOTIFICATIONS_PUBLIC_BROWSER_VISUAL_SMOKE_PENDING
