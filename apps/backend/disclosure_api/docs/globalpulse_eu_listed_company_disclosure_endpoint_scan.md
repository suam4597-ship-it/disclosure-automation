...
Fly staging live poll and digest visibility remain pending.
...
35. Keep Denmark DFSA OAM Company Announcements as a manual_staging_only official OAM candidate; use the bounded JSON search API with issuer/prospectus categories, exclude ShortSelling, and prove local/live parser smoke plus Fly staging smoke before any scheduled promotion.
