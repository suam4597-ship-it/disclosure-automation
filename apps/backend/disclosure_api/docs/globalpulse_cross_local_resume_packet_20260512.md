...
8. If #561/#565 receive approved production values, prepare a production config/smoke PR using the existing templates.
9. If no approval values exist, keep working on staging-only observation, docs, and source evidence.
```
