...
Taiwan official endpoint: MOPS daily material-information JSON endpoint confirmed; source registration blocked pending bounded date-aware POST adapter/parser
...
8. Add a bounded inactive Taiwan MOPS daily material-information adapter/source candidate.
...
TAIWAN_MOPS_SOURCE_REGISTRATION_PENDING_DATE_AWARE_POST_ADAPTER
