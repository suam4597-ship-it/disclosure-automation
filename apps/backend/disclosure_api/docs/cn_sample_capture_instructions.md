...
These instructions define how to capture one deterministic public CN disclosure sample after the source-surface inspection is complete.
...
2. discovery row + detail page: preferred minimum
