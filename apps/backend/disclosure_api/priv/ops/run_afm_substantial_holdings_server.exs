...
Application.put_env(
  ...
  AFMSubstantialHoldingsSource.sample_path()
)
...
IO.puts("AFM substantial holdings isolated dev server started on http://127.0.0.1:4000")
IO.puts("source_registry_path override: #{AFMSubstantialHoldingsSource.sample_path()}")
