-- AFM substantial holdings storage-level dedupe verification
...
-- 7) current verified AFM fixture spot check
SELECT
  external_id,
  COUNT(*) AS row_count
FROM raw_documents
WHERE external_id IN ('afm-sh-20260312-0001:register-export', 'afm-sh-20260312-0001:detail-page')
