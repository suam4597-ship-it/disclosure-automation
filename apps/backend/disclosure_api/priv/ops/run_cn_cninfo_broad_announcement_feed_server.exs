...
Application.put_env(:disclosure_automation, :source_registry_path, CNCNInfoBroadAnnouncementFeedSource.sample_path())
...
IO.puts("CNInfo broad announcement feed isolated dev server started on http://127.0.0.1:4000")
IO.puts("source_registry_path override: " <> CNCNInfoBroadAnnouncementFeedSource.sample_path())
