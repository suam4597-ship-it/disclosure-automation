-- SEC SC TO-T sibling storage-level dedupe verification
...
-- 7) current verified accession spot check for the SC TO-T fixture
SELECT
  external_id,
  COUNT(*) AS row_count
FROM raw_documents
WHERE external_id IN ('0000950123-26-001234:submission-text', '0000950123-26-001234:detail-index')
