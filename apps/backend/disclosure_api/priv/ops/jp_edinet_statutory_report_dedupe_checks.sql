-- JP EDINET statutory report storage-level dedupe verification
...
-- 7) current verified JP EDINET fixture spot check
SELECT external_id, COUNT(*) AS row_count
FROM raw_documents
WHERE external_id IN (
  'EDINET:S100XZXO:document-list-row',
  'EDINET:S100XZXO:primary-document:type1'
)
