...
Application.put_env(:disclosure_automation, :source_registry_path, JPTDnetBroadTimelyDisclosureSource.sample_path())
...
IO.puts("JP TDnet broad timely-disclosure isolated dev server started on http://127.0.0.1:4000")
IO.puts("source_registry_path override: " <> JPTDnetBroadTimelyDisclosureSource.sample_path())
