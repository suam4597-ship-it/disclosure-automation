-- SEC 8-K sibling storage-level dedupe verification
...
-- 7) current verified accession spot check for the 8-K fixture
SELECT
  external_id,
  COUNT(*) AS row_count
FROM raw_documents
WHERE external_id IN ('0001140361-26-006772:submission-text', '0001140361-26-006772:detail-index')
