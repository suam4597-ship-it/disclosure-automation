    ...
    <html lang=\"en\">
      ...
      <body data-view-scope=\"operator_only_duplicate_group_review\" data-group-id=\"#{escape_html(group_id)}\" data-detail-api-route=\"#{detail_api_route}\">
        <main id=\"duplicate-group-operator-detail-screen\">
          ...
          <section id=\"duplicate-group-action-controls\" data-action-controls=\"enabled\" data-operation-override=\"forbidden\" data-permission-aware=\"advisory-only\"><h2>Action Controls</h2><p>Buttons choose the locked action route. The request body does not include any route operation override.</p><p id=\"duplicate-group-action-permission-state\" data-permission-state=\"unknown\" aria-live=\"polite\">Permission state pending operator input.</p><form id=\"duplicate-group-action-form\" data-request-allowlist=\"bounded-redacted-action-request\"><label>actor_id_hash <input name=\"actor_id_hash\" value=\"sha256:operator-001\" autocomplete=\"off\"></label><label>actor_permissions <input name=\"actor_permissions\" value=\"duplicate_group:confirm,duplicate_group:reject,duplicate_group:mark_review,duplicate_group:clear_review_state\" autocomplete=\"off\"></label><label>roles <input name=\"roles\" value=\"operator\" autocomplete=\"off\"></label><label>request_id_hash <input name=\"request_id_hash\" placeholder=\"sha256:request-hash\" autocomplete=\"off\"></label><label>idempotency_key_hash <input name=\"idempotency_key_hash\" placeholder=\"sha256:idempotency-hash\" autocomplete=\"off\"></label><label>operator_reason_redacted <input name=\"operator_reason_redacted\" value=\"REDACTED_OPERATOR_REASON\" autocomplete=\"off\"></label><label>redaction_status <input name=\"redaction_status\" value=\"passed\" autocomplete=\"off\"></label><label>pre_review_state <input name=\"pre_review_state\" value=\"unknown\" autocomplete=\"off\"></label><button type=\"button\" data-action-control=\"confirm\" data-required-permission=\"duplicate_group:confirm\" data-action-route=\"#{confirm_api_route}\" data-post-review-state=\"confirmed_by_operator\">Confirm duplicate group</button><button type=\"button\" data-action-control=\"reject\" data-required-permission=\"duplicate_group:reject\" data-action-route=\"#{reject_api_route}\" data-post-review-state=\"rejected_by_operator\">Reject duplicate group</button><button type=\"button\" data-action-control=\"mark-review\" data-required-permission=\"duplicate_group:mark_review\" data-action-route=\"#{mark_review_api_route}\" data-post-review-state=\"needs_review\">Mark needs review</button><button type=\"button\" data-action-control=\"clear-review-state\" data-required-permission=\"duplicate_group:clear_review_state\" data-action-route=\"#{clear_review_state_api_route}\" data-post-review-state=\"cleared\">Clear review state</button></form><section id=\"duplicate-group-action-confirmation-modal\" role=\"dialog\" aria-modal=\"true\" data-confirmation-state=\"closed\" hidden><h2 id=\"duplicate-group-action-confirmation-title\">Confirm operator action</h2><p>This confirmation is bounded and redacted. Route-derived operation remains authoritative.</p><dl><dt>group_id</dt><dd data-confirmation-field=\"group_id\"></dd><dt>action label</dt><dd data-confirmation-field=\"action_label\"></dd><dt>locked route path</dt><dd data-confirmation-field=\"locked_route_path\"></dd><dt>post_review_state</dt><dd data-confirmation-field=\"post_review_state\"></dd><dt>operator_reason_redacted</dt><dd data-confirmation-field=\"operator_reason_redacted\"></dd><dt>idempotency_key_hash</dt><dd data-confirmation-field=\"idempotency_key_hash\"></dd></dl><p data-redaction-warning=\"bounded\">Use only hashed or redacted operator metadata.</p><button type=\"button\" id=\"duplicate-group-action-confirm-submit\">Submit confirmed action</button><button type=\"button\" id=\"duplicate-group-action-confirm-cancel\">Cancel</button></section><p id=\"duplicate-group-action-status\" data-action-status=\"ready\" data-state=\"ready\" aria-live=\"polite\">Ready for an operator action.</p><p id=\"duplicate-group-action-loading-state\" data-state=\"loading\" hidden>Submitting action.</p><p id=\"duplicate-group-action-error-state\" data-state=\"error\" data-error-category=\"unable_to_submit_action\" hidden>Unable to submit action.</p><p id=\"duplicate-group-action-success-state\" data-state=\"success\" hidden>Action submitted and detail refreshed.</p><pre id=\"duplicate-group-action-result\" data-action-result=\"bounded\"></pre></section>
        </main>
        <script>
          (function () {
